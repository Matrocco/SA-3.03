...
1. 
**Autonomie (30h - Groupes de 2)** : Définition du plan détaillé, configuration des équipements réseaux via simulation (Packet Tracer, GNS3) et création des machines virtuelles.


2. 
**Encadrement (4h)** : Aide aux étudiants de RT1 sur leur SAÉ 12, ce qui servira également à votre propre infrastructure.


3. 
**Réalisation et Mise en production (2 jours - Groupes de 4)** : Câblage physique, injection des configurations et déploiement réel des services.


4. 
**Soutenance (20 min)** : Évaluation individuelle sur l'ensemble du projet.
